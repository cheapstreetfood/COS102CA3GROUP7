...
class ImageTextWidget(tk.Frame):
    def __init__(self, parent, main_image_path, username_text, caption_text, pfp_path, *args, **kwargs):
...
class DiscoverPanel(tk.Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        # Replaced all configurations and hover links with explicit helper functions instead of lambdas
        ...
        # Standard loop back into __init__ just like before
        self.posts = []
        for i in range(6):  
            row_idx = i // 2
            col_idx = i % 2
...
class DiscoverPage(tk.Toplevel):    
    def __init__(self,master = None):
        ...
        self.discovericon = ImageTk.PhotoImage(Image.open("discovericon.png"))
        self.messageicon = ImageTk.PhotoImage(Image.open("messageicon.png"))
        self.connecticon = ImageTk.PhotoImage(Image.open("connecticon.png"))
